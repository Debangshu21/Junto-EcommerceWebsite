...
const FeaturedProducts = ({ featuredProducts }) => {
    ...
    // current index of the slide, changing it displays the next slide
    const [currentIndex, setCurrentIndex] = useState(0);
    // number of items per slide at start, changes later on if user resizes the page
    const [itemsPerPage, setItemsPerPage] = useState(4);

    const { addToCart } = useCartStore();

    // If user resizes the page then update the number of items per page
    useEffect(() => {
        const handleResize = () => {
    ...
    // Check if the start and end buttons should be disabled
            ...
            <div className='container mx-auto px-4'>
                ...
                <div className='relative'>
                    <div className='overflow-hidden'>
                        {/* Slide container containing featured produdcts */}
                        <div
